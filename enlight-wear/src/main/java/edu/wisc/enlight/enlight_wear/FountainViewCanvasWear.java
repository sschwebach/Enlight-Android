 ...
 */
public class FountainViewCanvasWear extends View {
    ...
    private FountainViewWear fView;

    public FountainViewCanvasWear(Context context, boolean left){
        super(context);
        this.left = left;
    ...
    public FountainViewCanvasWear(Context context, boolean left, FountainViewWear fView){
        super(context);
        this.left = left;
        paintLine.setAntiAlias(true);
        paintLine.setColor(Color.BLACK);
